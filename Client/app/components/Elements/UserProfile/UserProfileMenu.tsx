            ...
            <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                    <div className="flex justify-between items-center mb-4">
                        <button className="text-gray-500 hover:text-gray-700" aria-label="Close Modal"
                            onClick={() => setActiveUserProfileMenu(false)}>
                            ✕
                        </button>
                    </div>
                    <div className="flex flex-col items-center gap-3">
                        <img src="https://res.cloudinary.com/demo/image/upload/w_100,h_100,c_thumb,g_face,r_20,d_avatar.png/non_existing_id.png" alt="User Avatar" className="w-20 h-20 rounded-full border border-gray-300 shadow" />
